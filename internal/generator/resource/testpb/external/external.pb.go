...
const file_external_external_proto_rawDesc = "" +
	"\n" +
	"\x17external/external.proto\x12\x0etests.external\x1a\x19google/api/resource.protoB\x87\x01\xeaA+\n" +
	"\x14example.com/External\x12\x13external/{external}ZWgithub.com/protoc-contrib/protoc-gen-go-aip/internal/generator/resource/testpb/externalb\x06proto3"
